...
struct WebMarkdownView: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading) {
            MarkdownWebView(markdownString)
...
class WebMarkdownCell: UITableViewCell, Updatable {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        let markdownView = WebMarkdownView(markdownString: markdownString)
