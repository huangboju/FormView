//
//  XYPHSearchInteractionDismissAnimator.m
//  Prophets
//
...
@interface XYPHSearchInteractionDismissAnimator()

@property (strong, nonatomic) UIPercentDrivenInteractiveTransition *percentDrivenTransition;

@end

@implementation XYPHSearchInteractionDismissAnimator
...
- (id<UIViewControllerAnimatedTransitioning>)animationControllerForDismissedController:(UIViewController *)dismissed {
    return [[XYPHSearchInteractionDismissTransition alloc] initWithDuration:0.5];
}
