...
@interface MTDevGroupTableController : UIViewController

@property(nonatomic, strong) UITableView *tableView;

@property(nonatomic, strong) NSArray <NSArray <MTDevRow *>*>*form;
...
@interface MTDevGroupTableController (SubclassingHooks)
